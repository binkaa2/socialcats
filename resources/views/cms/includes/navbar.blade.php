<!-- Navbar include place -->
<header class="app-header navbar">
      <button class="navbar-toggler sidebar-toggler d-lg-none mr-auto" type="button" data-toggle="sidebar-show">
        <span class="navbar-toggler-icon"></span>
      </button>
      <a class="navbar-brand" href="#">
        <img class="navbar-brand-full" src="{{ asset('cms/assets/img/brand/logo.png')}}" width="150" height="50" alt="Social Cats">
        <img class="navbar-brand-minimized" src="{{ asset('cms/assets/img/brand/logo.png')}}" width="30" height="30" alt="Social Cats">
      </a>
